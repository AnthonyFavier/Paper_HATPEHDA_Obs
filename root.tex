...
% \textcolor{red}{
% In this work, we assume that the robot is always aware of the world state, while the human agent may hold a belief that does not exist in the real world. 
% Moreover, both agents can update their individual belief state but they are always certain about each fact (no uncertainties). 
% }
