...
\begin{figure}[t]
\centering
\includegraphics[width=0.9\columnwidth]{aaai22/figure1} % Reduce the figure size so that it is slightly narrower than the column. Don't use precise values for figure width.This setup will avoid overfull boxes.
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.8\textwidth]{aaai22/figure2} % Reduce the figure size so that it is slightly narrower than the column.
