...
Moreover, it also helps the robot to create a situation that will \textit{promote} an action to be executed by the human agent and is \text{relevant} to achieving the joint task.       
...
% The following discussion assumes that the robot knows the    
