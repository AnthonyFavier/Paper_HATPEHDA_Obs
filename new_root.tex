...
Note that we discuss only a high-level, general framework here and minor details are purposely skipped due to the page limit. For more details on this the reader is refereed to~\cite{thesisBuisan21,buisan:hal-03684211}. 
...
All combination of initial state and belief divergences (no divergence on robot and human position)

All combination : with contribution = 100\%, without contribution = 25.7\%
...
\begin{itemize}
    ...
    \item div on pasta loc always leads to failure without
