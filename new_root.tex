...
% In this work, 
We establish protocols between each sender-receiver agents pair for communication (and one may use speech modality), and model explicit communication actions between them. 
...
A principled way to handle those conventions is crucial for robust planning, as, otherwise, it can lead to difficulty at run-time. 
